...
class LemburJuniController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexjuni')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createjuni')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/juni/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/juni');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editjuni')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/juni/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
