...
class BaweanController extends Controller {
    ...
    public function index()
    {
        ...
        return view('bawean.index')->with('data',$data)->with('bulan',$bulan);
    }
    ...
    public function cetak($id)
    {
        ...
        $nomor = $nom[1];
        $tahun = $nom[3];
        $view = View::make('bawean.cetak', array('data' => $data, 'pengikut' => $pengikut, 'ttd1' => $ttd1, 'ttd2' => $ttd2, 'nomor' => $nomor, 
    ...
    public function create()
    {
        ...
        return view('bawean.create')->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)->with('lokasi',$lokasi)->with('ttd',$ttd);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/bawean')->withErrors($validator)->withInput();
        }
        else{
    ...
    public function edit($id)
    {
        ...
        return view('bawean.edit')->with('data',$data)->with('pengikut',$pengikut)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)->with('lokasi',$lokasi)->with('hasil',$hasil)->with('ttd',$ttd)->with('akomodasi',$akomodasi)->with('jmlako',$jmlako);
    }
