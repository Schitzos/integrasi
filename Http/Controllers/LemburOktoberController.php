...
class LemburOktoberController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexoktober')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createoktober')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/oktober/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/oktober');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editoktober')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/oktober/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
