...
class LemburNovemberController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexnovember')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createnovember')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/november/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/november');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editnovember')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/november/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
