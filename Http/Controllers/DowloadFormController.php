...
class DowloadFormController extends Controller
{
    /**
    ...
    public function index($id)
    {
        $data = DB::table('paket')
            ->where('id_paket','=',$id)
            ->first();
        return view('detail.dowloadform')->with('data', $data);
    }
    ...
    public function store()
    {
      ...
      if ($validator->fails())
      {   
            return Redirect::to('/pengendalian/'.$idpaket)->withErrors($validator)->withInput();
      }else
      {
            ...
            if ($extension=='xls'||$extension=='xlsx') {
                ...
                return Redirect::to('/pengendalian/'.$idpaket);
            }
        }
    }
