...
class LemburAgustusController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexagustus')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createagustus')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/agustus/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/agustus');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editagustus')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/agustus/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
