...
class LemburSeptemberController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexseptember')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createseptember')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/september/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/september');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editseptember')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/september/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
    ...
    public function cetak($id)
    {
        ...
        $ppk =  DB::table('pegawai as p')
            ...
            ->join('golongan as g','p.id_golongan','=','g.id_golongan')
            ->join('bidang as b','b.id_bidang','=','b.id_bidang')
