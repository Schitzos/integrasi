...
class LemburAprilController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexapril')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createapril')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/april/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/april');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editapril')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/april/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
