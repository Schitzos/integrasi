...
class LemburMaretController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexmaret')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createmaret')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/maret/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/maret');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editmaret')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/maret/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
