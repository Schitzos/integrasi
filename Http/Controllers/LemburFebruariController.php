...
class LemburFebruariController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexfebruari')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createfebruari')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/februari/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/februari');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editfebruari')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/februari/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
