...
class LemburMeiController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexmei')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createmei')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/mei/create')->withErrors($validator)->withInput();
        }else{
    ...
    public function edit($id)
    {
        ...
        return view('lembur.editmei')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/mei/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
