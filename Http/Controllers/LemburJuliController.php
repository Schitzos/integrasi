...
class LemburJuliController extends Controller {
    ...
    public function index()
    {
        ...
        return view('lembur.indexjuli')->with('data',$data);
    }
    ...
    public function create()
    {
        ...
        return view('lembur.createjuli')->with('kegiatan',$kegiatan)->with('rekeknig',$rekeknig);
    }
    ...
    public function store()
    {
        ...
        if ($validator->fails()){   
            return Redirect::to('/lembur/juli/create')->withErrors($validator)->withInput();
        }else{
            ...
            return Redirect::to('/lembur/juli');
        }
    }
    public function edit($id)
    {
        ...
        return view('lembur.editjuli')->with('data',$data)->with('pegawai',$pegawai)->with('kegiatan',$kegiatan)
    ...
    public function update()
    {
        ...
        $validator = Validator::make(Input::all(), $rules,$messages);
        if ($validator->fails()) {   
            return Redirect::to('/lembur/juli/'.$id.'/edit')->withErrors($validator)->withInput();
        } else { 
